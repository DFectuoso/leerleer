  ...
  render () {
    return (<div className='field'>
      <label className='label' htmlFor={this.props.id}>
        {this.props.name} {this.props.required && <span className='required'>*</span>}
      </label>
      ...
      <div className='control'>
        <label className='checkbox' htmlFor={this.props.id}>
          <input
            id={this.props.id}
            type='checkbox'
            checked={(this.props.value || this.props.default) || false}
            required={this.props.required}
            disabled={this.props.disabled || this.props.readonly}
            autoFocus={this.props.autofocus}
...
class MarbleForm extends Component {
  constructor (props) {
    ...
    this.state = {
      ...
      schema: props.schema || {},
      message: props.message || 'Los datos se han guardado correctamente',
  ...
  componentWillReceiveProps (props) {
    ...
    const formData = 'formData' in props ? props.formData : initialData
